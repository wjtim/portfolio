...
const AboutMe = () => {
  return (
    ...
    <div className="text-m font-mono px-10 my-3 text-center"> I have a passion for development using both <strong className='text-yellow-500'>Javascript</strong>, <strong className='text-blue-500'>Python</strong>, and more! </div>
