...
const AboutMe = () => {
  return (
    ...
    <div className="text-m font-mono px-10 my-3 text-center"> I also love <strong className='text-orange-500'>analyzing data</strong> and creating <strong className='text-orange-500'>data visualisations</strong>. </div>
